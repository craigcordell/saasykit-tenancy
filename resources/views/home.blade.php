<x-layouts.app>
    ...
    <x-section.hero class="w-full mb-8 md:mb-72">
        ...
        <div class="mx-auto text-center h-160 md:h-180 px-4">
            ...
            <p class="text-primary-50 m-3">
                {{ __('A Laravel-based boilerplate with everything you need to build an awesome SaaS.') }}</p>
            ...
            <div class="flex flex-wrap gap-4 justify-center flex-col md:flex-row mt-6">
                ...
                <x-button-link.primary-outline href="//demo.saasykit.com"
                    class=" bg-transparent self-center py-3! text-white border-white" rel=”nofollow”>
                    {{ __('Check The Demo') }}
            ...
            <x-user-ratings link="#testimonials" class="items-center justify-center mt-6 relative z-40">
                <x-slot name="avatars">
                    <x-user-ratings.avatar
                        src="https://unsplash.com/photos/rDEOVtE7vOs/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8Mnx8cGVyc29ufGVufDB8fHx8MTcxMzY4NDI1MHww&force=true&w=640"
                        alt="testimonial 1" />
                    <x-user-ratings.avatar
                        src="https://unsplash.com/photos/c_GmwfHBDzk/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8M3x8cGVyc29ufGVufDB8fHx8MTcxMzY4NDI1MHww&force=true&w=640"
                        alt="testimonial 2" />
                    <x-user-ratings.avatar
                        src="https://unsplash.com/photos/QXevDflbl8A/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8NHx8cGVyc29ufGVufDB8fHx8MTcxMzY4NDI1MHww&force=true&w=640"
                        alt="testimonial 3" />
                    <x-user-ratings.avatar
                        src="https://unsplash.com/photos/mjRwhvqEC0U/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8Nnx8cGVyc29ufGVufDB8fHx8MTcxMzY4NDI1MHww&force=true&w=640"
                        alt="testimonial 4" />
                    <x-user-ratings.avatar
                        src="https://unsplash.com/photos/C8Ta0gwPbQg/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8MTl8fHBlcnNvbnxlbnwwfHx8fDE3MTM2ODQyNTB8MA&force=true&w=640"
                        alt="testimonial 5" />
                </x-slot>
            ...
            <div class="mx-auto md:max-w-3xl lg:max-w-5xl">
                <img class="drop-shadow-2xl mt-8 transition hover:scale-101 rounded-2xl"
                    src="{{ URL::asset('/images/features/hero-image.png') }}" />
            </div>
        ...
        <x-section.column>
            ...
            <div class="flex gap-3 pt-1">
                <a href="https://stripe.com/" target="_blank">
                    <img src="{{ URL::asset('/images/payment-providers/stripe.png') }}"
                        class="h-12 py-2 px-2 border border-primary-50 rounded-lg" />
                </a>
                <a href="https://www.paddle.com/" target="_blank">
                    <img src="{{ URL::asset('/images/payment-providers/paddle.png') }}"
                        class="h-12 py-2 px-2 border border-primary-50 rounded-lg" />
                </a>
            </div>
        </x-section.column>
    ...
    <div class="text-center p-4 mx-auto">
        ...
        <div class="flex flex-wrap items-center justify-center gap-12 mt-8">
            <img src="{{ URL::asset('/images/tech-stack/laravel.svg') }}"
                class="h-10 hover:cursor-pointer hover:scale-103 hover:opacity-100 transition grayscale hover:grayscale-0 opacity-50" />
            <img src="{{ URL::asset('/images/tech-stack/filament.avif') }}"
                class="h-10 hover:cursor-pointer hover:scale-103 hover:opacity-100 transition grayscale hover:grayscale-0 opacity-50" />
            <img src="{{ URL::asset('/images/tech-stack/tailwindcss.svg') }}"
                class="h-12 hover:cursor-pointer hover:scale-103 hover:opacity-100 transition grayscale hover:grayscale-0 opacity-50" />
            <img src="{{ URL::asset('/images/tech-stack/livewire.png') }}"
                class="h-20 hover:cursor-pointer hover:scale-103 hover:opacity-100 transition grayscale hover:grayscale-0 opacity-50" />
            <img src="{{ URL::asset('/images/tech-stack/alpinejs.svg') }}"
                class="h-16 hover:cursor-pointer hover:scale-103 hover:opacity-100 transition grayscale hover:grayscale-0 opacity-50" />
        </div>
    ...
    <div class="text-center mt-16 p-4">
        ...
        <flux:calendar value="2025-09-10" />
    ...
    <div class="mx-4">
        <x-tab-slider class="mt-6 md:max-w-6xl border-2 border-neutral-100 py-8 rounded-2xl">
            <x-slot name="tabNames">
                <x-tab-slider.tab-name controls="tab-1"
                    active="true">{{ __('Testimonials') }}</x-tab-slider.tab-name>
            ...
            <x-tab-slider.tab-content id="tab-1">
                ...
                <div class="m-10 mx-auto max-w-4xl mt-12">
                    <img src="{{ URL::asset('/images/features/testimonials.png') }}"
                        class="drop-shadow-xl rounded-2xl" />
                </div>
            ...
            <x-tab-slider.tab-content id="tab-2">
                ...
                <div class="m-10 mx-auto max-w-4xl mt-12">
                    <img src="{{ URL::asset('/images/features/plans-component.png') }}"
                        class="drop-shadow-xl rounded-2xl" />
                </div>
            ...
            <x-tab-slider.tab-content id="tab-3">
                ...
                <div class="m-10 mx-auto max-w-4xl mt-12">
                    <img src="{{ URL::asset('/images/features/hero-component.png') }}"
                        class="drop-shadow-xl rounded-2xl" />
                </div>
            ...
            <x-tab-slider.tab-content id="tab-4">
                ...
                <div class="m-10 mx-auto max-w-4xl mt-12">
                    <img src="{{ URL::asset('/images/features/faqs-component.png') }}"
                        class="drop-shadow-xl rounded-2xl" />
                </div>
            ...
            <x-tab-slider.tab-content id="tab-5">
                ...
                <div class="m-10 mx-auto max-w-4xl mt-12">
                    <img src="{{ URL::asset('/images/features/call-to-action-component.png') }}"
                        class="drop-shadow-xl rounded-2xl">
                </div>
            ...
            <x-tab-slider.tab-content id="tab-6">
                ...
                <div class="m-10 mx-auto max-w-4xl mt-12">
                    <img src="{{ URL::asset('/images/features/tab-slider-component.png') }}"
                        class="drop-shadow-xl rounded-2xl">
                </div>
    ...
    <p class="text-center py-4">
        {{ __('Manage your SaaS application from a beautiful admin panel powered by Filament') }}</p>
    ...
    <x-section.columns class="max-w-none md:max-w-6xl mt-6">
        <x-section.column class="flex flex-col items-center justify-center text-center">
            ...
            <p class="mt-2">
                {{ __('Users can manage their subscriptions, change payment method, upgrade plan, cancel subscription alone.') }}
            </p>
        </x-section.column>
        ...
        <x-section.column class="flex flex-col items-center justify-center text-center">
            ...
            <p class="mt-2">
                {{ __('Manage your SaaS settings from within the admin panel. No need to redeploy app for simple changes anymore.') }}
            </p>
        </x-section.column>
        ...
        <x-section.column class="flex flex-col items-center justify-center text-center">
            ...
            <p class="mt-2">
                {{ __('Built with developers in mind, uses best coding practices. Offers handlers & events and automated tests covering critical components of the application.') }}
            </p>
        </x-section.column>
    ...
    <p class="text-center p-4">
        {{ __('Deploy your SaaS application to your server with a single command, powered by') }} <a
            href="https://deployer.org/" target="_blank"
            class="text-primary-500 hover:underline">{{ __('PHP Deployer') }}</a>. </p>
        ...
        <x-accordion class="mt-4 p-8">
            ...
            <x-accordion.item active="false" name="faqs">
                ...
                <ul class="mt-4 list-disc ms-4 ps-4">
                    <li>{{ __('Customize Styles: Customize the styles &amp; colors, error page of your application to fit your brand.') }}
                    </li>
                    <li>{{ __('Product, Plans &amp; Pricing: Create and manage your products, plans, and pricing from a beautiful and easy-to-use admin panel.') }}
                    </li>
                    <li>{{ __('Beautiful checkout process: Your customers can subscribe to your plans from a beautiful checkout process.') }}
                    </li>
                    <li>{{ __('Huge list of ready-to-use components: Plans &amp; Pricing, hero section, features section, testimonials, FAQ, Call to action, tab slider, and much more.') }}
                    </li>
                    <li>{{ __('User authentication: Comes with user authentication out of the box, whether classic email/password or social login (Google, Facebook, Twitter, Github, LinkedIn, and more).') }}
                    </li>
                    ...
                    <li>{{ __('Multiple email providers: Mailgun, Postmark, Amazon SES, and more coming soon.') }}
                    </li>
                    <li>{{ __('Blog: Create and manage your blog posts.') }}</li>
                    <li>{{ __('User &amp; Role Management: Create and manage your users and roles, and assign permissions to your users.') }}
                    </li>
                    ...
                    <li>{{ __('Automated Tests: Comes with automated tests for critical components of the application.') }}
                    </li>
                    <li>{{ __('One-line deployment: Provision your server and deploy your application easily with integrated') }}
                        <a href="https://deployer.org/" target="_blank" rel="noopener noreferrer">Deployer</a>
                        {{ __('  support.') }}
                    </li>
                    <li>{{ __('Developer-friendly: Built with developers in mind, uses best coding practices.') }}
                    </li>
            ...
            <x-accordion.item active="false" name="faqs">
                ...
                <p>
                    ...
                    <a href="mailto:{{ config('app.support_email') }}"
                        class="text-primary-500 hover:underline">{{ config('app.support_email') }}</a>
                    {{ __('or join our') }} <a
                        href="{{ config('app.social_links.discord') }}">{{ __('discord server') }}</a>
                    {{ __('to get help.') }}
                </p>
            ...
            <x-accordion.item active="false" name="faqs">
                ...
                <p>
                    {{ __('SaaSykit is built on top of') }} <a href="https://laravel.com"
                        target="_blank">Laravel</a> {{ __('Laravel, the most popular PHP framework, and') }} <a
                        target="_blank" href="https://filamentphp.com/">Filament</a>
                    {{ __(', a beautiful and powerful admin panel for Laravel. It also uses TailwindCSS, AlpineJS, and Livewire.') }}
                </p>
                <p class="mt-4">
